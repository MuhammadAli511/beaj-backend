...
const getAllUserProgressRepository = async (targetGroup,cohort,module,courseId1,courseId2,courseId3) => {
    console.log(targetGroup,cohort,module,courseId1,courseId2,courseId3);
    let array_list = [];
...
const getUserProgressLeaderboardRepository = async (targetGroup,cohort,module,courseId1,courseId2,courseId3) => {
    console.log(targetGroup,cohort,module,courseId1,courseId2,courseId3);
    let array_list = [];
...
const getColumnIndexWithPercentageValues = (arrayLevels_List, minValues) => {
...
export default {
    ...
    getUserProgressLeaderboardRepository
};
