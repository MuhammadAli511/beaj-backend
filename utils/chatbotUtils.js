  ...
  try {
    ...
    if (activity === "video") {
      ...
      if (currentUserState.dataValues.questionNumber === null) {
        ...
        // Send lesson message
        let lessonMessage =
          "Listen to the audio question and record your answer as a voice note.💬";
      ...
      if (currentUserState.dataValues.questionNumber === null) {
        ...
        if (nextWatchAndSpeakQuestion) {
          ...
          // Send question text
          let message =
            "Now you practice speaking by recording a voice note.💬";
...
const thankYouMessage = async (userMobileNumber) => {
  const message =
    "Thank you for applying! We will call you by Nov 1st to confirm if you get selected for this batch.";
  await sendMessage(userMobileNumber, message);
