...
import { createAndUploadScoreImage, createAndUploadMonologueScoreImage, createAndUploadSpeakingPracticeScoreImage } from "./imageGenerationUtils.js";
...
const sendCourseLessonToTeacher = async (userMobileNumber, currentUserState, startingLesson, messageType, messageContent) => {
    try {
        ...
        if (activity === 'video') {
            ...
            await watchAndImageView(userMobileNumber, currentUserState, startingLesson, messageType, messageContent);
        }
