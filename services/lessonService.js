...
const validateIngestionService = async (sheetId, sheetTitle, courseId) => {
    try {
        const result = await validateIngestion(sheetId, sheetTitle, courseId);
        return result;
    } catch (error) {
        error.fileName = 'lessonService.js';
        throw error;
...
const processIngestionService = async (courseId, sheetId, sheetTitle, validationResult) => {
    try {
        const result = await processIngestion(courseId, sheetId, sheetTitle, validationResult);
        return result;
    } catch (error) {
        error.fileName = 'lessonService.js';
        throw error;
...
const getLessonsByCourseIdService = async (courseId) => {
    try {
