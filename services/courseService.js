...
const duplicateCourseService = async (id) => {
    try {
        ...
        for (const lesson of lessons) {
            ...
            if (lesson.dataValues.activity == 'listenAndSpeak' || lesson.dataValues.activity == 'watchAndSpeak' || lesson.dataValues.activity == 'watchAndAudio' || lesson.dataValues.activity == 'watchAndImage' || lesson.dataValues.activity == 'conversationalQuestionsBot' || lesson.dataValues.activity == 'conversationalMonologueBot' || lesson.dataValues.activity == 'conversationalAgencyBot' || lesson.dataValues.activity == 'speakingPractice' || lesson.dataValues.activity == 'feedbackAudio' || lesson.dataValues.activity == 'assessmentWatchAndSpeak' || lesson.dataValues.activity == 'assessmentWatchAndAudio' || lesson.dataValues.activity == 'assessmentWatchAndImage') {
